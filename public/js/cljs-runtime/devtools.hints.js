...
var G__27147 = cljs.core.PersistentArrayMap.EMPTY;
var G__27148 = native_stack_trace;
var G__27149 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__27150 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__27147,G__27148,G__27149,G__27150) : cljs.stacktrace.parse_stacktrace.call(null,G__27147,G__27148,G__27149,G__27150));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27161__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27161__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27161__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e27154){var _e = e27154;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___27220 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___27220)){
var seen_errors_27221 = temp__5733__auto___27220;
if(cljs.core.truth_(seen_errors_27221.has(self))){
} else {
seen_errors_27221.add(self);

var temp__5735__auto___27222 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___27222)){
var sense_27223 = temp__5735__auto___27222;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_27223)].join('');
} else {
}
}
} else {
