...
var G__37651 = o;
(G__37651[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
G__37784.cljs$lang$applyTo = (function (arglist__37788){
...
var G__37656 = o;
(G__37656[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__37826__i < G__37826__a.length) {G__37826__a[G__37826__i] = arguments[G__37826__i + 0]; ++G__37826__i;}
  args = new cljs.core.IndexedSeq(G__37826__a,0,null);
} 
return G__37821__delegate.call(this,args);};
G__37821.cljs$lang$maxFixedArity = 0;
G__37821.cljs$lang$applyTo = (function (arglist__37829){
...
var G__37661 = props;
var G__37661__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37661,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37661);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37661__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37662){
var map__37664 = p__37662;
var map__37664__$1 = (((((!((map__37664 == null))))?(((((map__37664.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37664.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37664):map__37664);
var props = map__37664__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37664__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37672){
var map__37673 = p__37672;
var map__37673__$1 = (((((!((map__37673 == null))))?(((((map__37673.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37673.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37673):map__37673);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37673__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__37673,map__37673__$1,on_write){
return (function (){
...
});})(node_value,map__37673,map__37673__$1,on_write))
);
} else {
...
var G__37691 = jsprops;
(G__37691["defaultValue"] = value);

(G__37691["onChange"] = ((function (G__37691,v,value,on_change){
return (function (p1__37685_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__37685_SHARP_);
});})(G__37691,v,value,on_change))
);
...
var vec__37694 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37694,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37694,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37694,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___37913 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___37913 == null)){
} else {
var key_37915 = temp__5739__auto___37913;
...
var temp__5739__auto___37919 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___37919 == null)){
} else {
var key_37920 = temp__5739__auto___37919;
reagent.impl.template.oset(jsprops,"key",key_37920);
}
...
var G__37701 = reagent.impl.template.__GT_NativeWrapper();
(G__37701["name"] = c);
...
var G__37711 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__37711) : reagent.impl.template.as_element.call(null,G__37711));
} else {
...
var len__4730__auto___37933 = arguments.length;
var i__4731__auto___37934 = (0);
while(true){
if((i__4731__auto___37934 < len__4730__auto___37933)){
args__4736__auto__.push((arguments[i__4731__auto___37934]));

var G__37935 = (i__4731__auto___37934 + (1));
i__4731__auto___37934 = G__37935;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37728){
var G__37729 = cljs.core.first(seq37728);
var seq37728__$1 = cljs.core.next(seq37728);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37729,seq37728__$1);
});
...
break;
default:
var G__37943 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__37943;
continue;
...
var n__4607__auto___37944 = a.length;
var i_37945 = (0);
while(true){
if((i_37945 < n__4607__auto___37944)){
(a[i_37945] = reagent.impl.template.as_element((a[i_37945])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___37947 = a.length;
var i_37948 = (0);
while(true){
if((i_37948 < n__4607__auto___37947)){
var val_37949 = (a[i_37948]);
if(((cljs.core.vector_QMARK_(val_37949)) && ((reagent.impl.template.key_from_vec(val_37949) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37948] = reagent.impl.template.as_element(val_37949));

var G__37950 = (i_37948 + (1));
i_37948 = G__37950;
continue;
} else {
}
...
var ctx = ({});
var vec__37755 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37755,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37755,(1),null);
...
var G__37776 = (cljs.core.count(argv) - first_child);
switch (G__37776) {
case (0):
...
case (1):
var G__37777 = comp;
var G__37778 = jsprops;
var G__37779 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__37777,G__37778,G__37779);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__37776){
