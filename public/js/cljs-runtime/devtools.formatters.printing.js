...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27587){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27606_SHARP_){
return (!((cljs.core.meta(p1__27606_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27608__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27621){var _e__27002__auto__ = e27621;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e27623){var _e__27002__auto__ = e27623;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27629 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27630 = devtools.formatters.state.get_current_state();
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27630;

try{var map__27631 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27631__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27629;
}});
...
;
var temp__5733__auto___27687 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___27687)){
var managed_print_level_27688 = temp__5733__auto___27687;
var _STAR_print_level_STAR__orig_val__27638_27689 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27639_27690 = managed_print_level_27688;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27639_27690;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR__orig_val__27638_27689,_STAR_print_level_STAR__temp_val__27639_27690,managed_print_level_27688,temp__5733__auto___27687,writer,opts,job_fn){
return (function (p1__27637_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__27637_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__27638_27689,_STAR_print_level_STAR__temp_val__27639_27690,managed_print_level_27688,temp__5733__auto___27687,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27638_27689;
}} else {
job_fn();
}
